...
async function loadInitialeFixture(): Promise<InitialeFixture> {
  const fixturePath = fileURLToPath(new URL('../../../../fixtures/demandes/importateur/initiale.json', import.meta.url));
...
test.describe('Importateur Demande Initiale', () => {
  test('IMP-DEM-INIT-001 | Create and submit initiale demande', async ({ page }) => {
